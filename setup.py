...
setup(
    ...
    name="cyme-extract-tools",  # Required
    ...
    url="https://github.com/openfido/cyme-extract/tree/main",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="SLAC National Accelerator Laboratory - David Chassin",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="dchassin@stanford.edu",  # Optional
    ...
    keywords="gridlabd cyme conversion glm mdb",  # Optional
